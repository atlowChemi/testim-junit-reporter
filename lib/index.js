...
async function publishCommentOnPullRequest(token, commit, { accumulatedResult, testResults, conclusion, headSha }) {
  var _a;
  ...
  delay(500);
  const comments = commentsSearch.data.filter(({ user, body_html }) => (user == null ? void 0 : user.login) === "github-actions" && (body_html == null ? void 0 : body_html.startsWith('<h1 id="testim-junit-reporter-msg">')));
