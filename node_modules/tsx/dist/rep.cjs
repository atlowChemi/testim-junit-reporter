"use strict";var c=require("repl"),n=require("@esbuild-kit/core-utils"),i=require("./package-421ee107.cjs");function u(e){return e&&typeof e=="object"&&"default"in e?e:{default:e}}var p=u(c);console.log(`Welcome to tsx v${i.version} (Node.js ${process.version}).
